...
## Conditional depth
When evidence includes an error, warning, timeout, skipped check, unfinished background task, retry, or fallback, load [failure visibility](references/failure-visibility.md) before reporting the outcome.
